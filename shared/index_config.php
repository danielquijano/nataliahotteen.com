<?php 
	...
	$invited_models_attrs = array(
		array(
			'url' => 'blonde.php',
			'col' => 'col-md-4 col-px mt-2 mt-md-0 mb-2 mb-md-0 text-center',
			'alt' => 'Provocative slim blonde with tattoos',
			'img-md' => 'assets/images/invited-model/blonde-md.webp',
			'img-lg' => 'assets/images/invited-model/blonde-lg.webp',
		),
		array(
			'url' => 'hooker.php',
			'col' => 'col-6 col-md-4 col-px',
			'alt' => 'Mexican hooker',
